	...
	<ul>
			...
			<li class="nav-menu-icon" id="nav-contacts-linkmenu">
				...
				<ul id="nav-contacts-menu" class="menu-popup">
					<li id="nav-contacts-see-intro"><a href="$nav.notifications.0">$nav.introductions.1<span id="intro-update-li" class="nav-notify"></span></a></li>
			...
			<li  id="nav-messages-linkmenu" class="nav-menu-icon">
			  ...
			  <span class="icon messages">$nav.messages.1</span>
				...
				<ul id="nav-messages-menu" class="menu-popup">
					...
					<li id="nav-messages-see-all"><a href="$nav.messages.inbox.0">$nav.messages.inbox.1<span id="mail-update-li" class="nav-notify"></span></a></li>

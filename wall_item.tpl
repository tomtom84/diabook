...
<div class="wall-item-container $indent">
	...
	<div class="wall-item-bottom">
		...
		<div class="wall-item-actions">
			...
			{{ if $vote }}
				<a href="#" id="like-$id" class="icon like" title="$vote.like.0" onclick="dolike($id,'like'); return false"></a>
				<a href="#" id="dislike-$id" class="icon dislike" title="$vote.dislike.0" onclick="dolike($id,'dislike'); return false"></a>
			{{ endif }}
						
			{{ if $vote.share }}
				<a href="#" id="share-$id" class="icon recycle" title="$vote.share.0" onclick="jotShare($id); return false"></a>
			{{ endif }}			

			{{ if $star }}
				<a href="#" id="star-$id" class="icon unstarred" onclick="dostar($id); return false;" title="$star.do"></a>
				<a href="#" id="unstar-$id" class="icon star" onclick="dostar($id); return false;"  class="$star.classundo"  title="$star.undo">$star.undo</a>
				<a href="#" id="tagger-$id" onclick="itemTag($id); return false;" class="icon tagged" title="$star.tagger"></a>
			{{ endif }}
			</div>
